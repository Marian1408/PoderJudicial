            ...
            <div class="sticky-top mb-3">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Eventos habituales</h4>
                </div>
                <div class="card-body">
                  <!-- the events -->
                  <div id="external-events">
                    <div class="external-event bg-success">Lunes de conferencia 5:00 pm</div>
                    <div class="external-event bg-warning">Martes de Conferencia</div>
                    <div class="external-event bg-info">Miercoles de conferencia</div>
                    <div class="external-event bg-primary">Jueves de conferencia</div>
                    <div class="external-event bg-danger">Viernes de conferencia</div>
                    <div class="checkbox">
                ...
                <div class="card-body">
                  <div class="btn-group" style="width: 100%; margin-bottom: 10px;">
                    <ul class="fc-color-picker" id="color-chooser">
                      ...
                      <li><a class="text-muted"><i class="fas fa-square"></i></a></li>
                    </ul>
                  </div>
                  <!-- /btn-group -->
                  <div class="input-group">
                    <input id="new-event" type="text" class="form-control" placeholder="Tituto del evento">
...
<script>
  $(function () {
    ...
    var calendar = new Calendar(calendarEl, {
      ...
      events: [
        {
          title          : 'Evento en el B',
          start          : new Date(y, m, 1),
          backgroundColor: '#611A2B', //red
          borderColor    : '#611A2B', //red
          allDay         : true
        },
        {
          title          : 'Inaguración de Sala 3',
          start          : new Date(y, m, d - 5),
          end            : new Date(y, m, d - 2),
          backgroundColor: '#16342a', //yellow
          borderColor    : '#16342a' 
        },
        {
          title          : 'Día mundial contra el cancer',
          start          : new Date(y, m, d, 10, 30),
          allDay         : false,
          backgroundColor: '#611A2B', //Blue
          borderColor    : '#611A2B' //Blue
        },
        {
          title          : 'Día festivo',
          ...
          allDay         : false,
          backgroundColor: '#611A2B', //Info (aqua)
          borderColor    : '#611A2B' //Info (aqua)
        },
        {
          title          : 'Congreso',
          ...
          allDay         : false,
          backgroundColor: '#16342a', //Success (green)
          borderColor    : '#16342a' //Success (green)
        },
        {
          title          : 'Junta de cosejo',
          start          : new Date(y, m, 28),
          end            : new Date(y, m, 29),
          url            : 'https://www.poderjudicial.com/',
          backgroundColor: '##611A2B', //Primary (light-blue)
          borderColor    : '#611A2B' //Primary (light-blue)
        }
      ],
      editable  : true,
    ...
    /* ADDING EVENTS */
    var currColor = '#16342a' //Red by default
